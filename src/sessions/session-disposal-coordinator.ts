...
/**
 * Coordinate store snapshots, daemon leases, and context disposal without
 * holding the store lock while the daemon independently validates ownership.
 */
...
function sessionRoots(
  ...
  for (const pageId of pageIds) {
    ...
    // One lease protects the complete structural root, including all siblings.
